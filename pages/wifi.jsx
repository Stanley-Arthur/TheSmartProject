  ...
  return (
    <div className='flex justify-center flex-col items-center'>
      <div className="flex flex-col  md:mb-96 pt-20 h-[300px] md:min-h-screen w-full relative">
        <Image alt='' src="/img/cloud.jpg " className=' object-cover  w-full min-h-[300px] md:min-h-screen  ' width={1000} height={1000} />
        <span className=' bg-gradient-to-r  from-purple-500/50 to-pink-500/50 min-h-[300px] md:min-h-screen w-full absolute'/>
        ...
        <div className='absolute space-y-8 top-[40%] left-[25%] '>
          ...
          <div className= ' md:flex  md:flex-col md:items-center  md:justify-center hidden'>
      ...
      <div className='flex flex-1 items-center mb-10 justify-center mx-5 flex-col md:flex-row  mt-5'>
        ...
        <div className='md:w-[50%] w-full'>
          <Image className='w-[500px] min-h-[350px] object-cover' src="/img/cl.jpg" width={500} height={500} alt="" />
        </div>
      </div>
    </div>
  )
